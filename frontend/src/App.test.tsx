...
it.each(widths)(
	'should show a list of Clients and then select one with %o viewport',
	async width => {
...
it('redirects home page when trying to access an invalid fruit', async () => {
	render(<App />, {route: '/invalid-client'})
...
it('renders error', async () => {
	queryClient.clear()
	server.use(http.get('/clients', () => new HttpResponse(null, {status: 500})))
	render(<App />)
